public static class Trees
{
    ...
    private static void InsertMiddle(int[] sortedNumbers, int first, int last, BinarySearchTree bst)
    {
        ...
        InsertMiddle(sortedNumbers, first, mid - 1, bst); // Recursively insert elements before the middle
        InsertMiddle(sortedNumbers, mid + 1, last, bst); // Recursively insert elements after the middle
    }
}